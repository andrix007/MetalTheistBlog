...
namespace MetalTheist.Migrations
{
    ...
    [Migration("20210625073511_changedArticleDateTimeNullable")]
    partial class changedArticleDateTimeNullable
    {
            ...
            modelBuilder.Entity("MetalTheist.Data.Entities.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Title = "Hello",
                            UploadDate = new DateTime(2021, 6, 25, 10, 35, 10, 875, DateTimeKind.Local).AddTicks(2953)
                        });
                });
