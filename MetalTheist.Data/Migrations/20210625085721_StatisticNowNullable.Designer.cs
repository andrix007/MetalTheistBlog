...
namespace MetalTheist.Migrations
{
    ...
    [Migration("20210625085721_StatisticNowNullable")]
    partial class StatisticNowNullable
    {
            ...
            modelBuilder.Entity("MetalTheist.Data.Entities.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Title = "Hello",
                            UploadDate = new DateTime(2021, 6, 25, 11, 57, 21, 25, DateTimeKind.Local).AddTicks(7482)
                        });
                });
