...
namespace MetalTheist.Migrations
{
    ...
    [Migration("20210627131144_UserDateofRegistrationNullable")]
    partial class UserDateofRegistrationNullable
    {
            ...
            modelBuilder.Entity("MetalTheist.Data.Entities.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Title = "Hello",
                            UploadDate = new DateTime(2021, 6, 27, 16, 11, 43, 689, DateTimeKind.Local).AddTicks(5101)
                        });
                });
